...
namespace MqttClient
{
    ...
    public interface IPersistence
    {
        ...
        void AddMessage(IPersistentMessage m, MessageStore store);
        ...
        /// </summary>
        /// <param name="m">Message</param>
        void UpdateSentMessage(IPersistentMessage m);
        ...
        IPersistentMessage[] GetAllMessages(MessageStore store);
