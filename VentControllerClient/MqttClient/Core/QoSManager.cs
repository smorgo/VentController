...
using MqttClient.Core.Messages;
using MqttClient;
using MqttClient.Logger;
...
namespace MqttClient.Core
{
    internal class QoSManager
    {
        ...
        public void SetStreamManager(StreamManager strMan)
        {
			...
			_messageDaemonTask = Task.Run (MessageDaemon);
        }
